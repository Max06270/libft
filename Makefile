...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/09/25 15:54:50 by mkehon            #+#    #+#              #
#    Updated: 2017/09/25 15:56:07 by mkehon           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES += ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
		 ...
		 ft_memset.c ft_putchar.c ft_putstr.c ft_strcat.c \
		 ...
		 ft_tolower.c ft_toupper.c ft_memalloc.c ft_memdel.c \
